...
import ego.goods.web.client.BrandClient;
import ego.goods.web.client.CategoryClient;
import ego.goods.web.client.GoodsClient;
...
public class GoodsService {
    ...
    public Map<String, Object> loadModel(Long spuId) {
        ...
        //查询品牌信息
        Brand brand = brandClient.getBrandByBid(spuBo.getBrandId()).getBody();
        /**
         * 对于规格属性的处理需要注意以下几点：
         * 1. 所有规格都保存为id和name形式
        ...
        List<Map<String,Object>> allSpecs = JsonUtils.nativeRead(allSpecJson, new
...
//获取特有规格参数
        ...
        Map<String,String[]> specs = JsonUtils.nativeRead(specTJson, new
...
//按照组构造规格参数
    ...
    private List<Map<String, Object>> getGroupsSpec(List<Map<String, Object>> allSpecs,
                                                    Map<Integer, String> specName, Map<Integer, Object> specValue) {
    ...
    private void getSpecialSpec(Map<String, String[]> specs, Map<Integer, String> specName,
                                Map<Integer, Object> specValue, Map<Integer, String> specialParamName, Map<Integer, String[]>
                                        specialParamValue) {
        if (specs != null) {
...
//因为是放在数组里面，所以要先去除两个方括号，然后再以逗号分割成数组
    ...
    private void getAllSpecifications(List<Map<String, Object>> allSpecs, Map<Integer, String>
            specName, Map<Integer, Object> specValue) {
        String k = "k";
        String v = "v";
        String unit = "unit";
